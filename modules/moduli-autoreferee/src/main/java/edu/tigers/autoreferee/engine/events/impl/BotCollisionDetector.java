...
import edu.tigers.autoreferee.engine.events.data.BotCrashDrawn;
import edu.tigers.autoreferee.engine.events.data.BotCrashUnique;
	...
	private Optional<IGameEvent> checkForCrashEvent(List<BotPair> consideredBotPairs, IAutoRefFrame frame)
	{
		...
		for (BotPair pair : consideredBotPairs)
		{
			...
			if (secondaryViolator == null)
			{
				...
				return Optional.of(new BotCrashUnique(false, primaryBot, secondaryBot, centerPos, primarySpeed,
