...
public abstract class AUnscentedKalmanFilter
{
	...
	private final List<Integer> orientationComponentsState = new ArrayList<>();
	private final List<Integer> orientationComponentsMeas = new ArrayList<>();
	 ...
	 */
	protected AUnscentedKalmanFilter(final int numStates, final int numMeas, final int numControl)
	{
	...
	private void drawSigmaPoints()
	{
		...
		if (numStates >= 0)
		{
			System.arraycopy(xA, 0, XkA[0], 0, numStates);
		}
